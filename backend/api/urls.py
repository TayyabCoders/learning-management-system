...
urlpatterns = [
    ...
    path("course/cart-list/<user_id>/", api_views.CartListAPIView.as_view()),
    path("course/cart-item-delete/<user_id>/<item_id>/", api_views.CartItemDeleteAPIView.as_view()),
    path("cart/stats/<user_id>/", api_views.CartStatsAPIView.as_view()),
    ...
    path("teacher/course-detail/<course_id>/", api_views.CourseDetailAPIViews.as_view()),
